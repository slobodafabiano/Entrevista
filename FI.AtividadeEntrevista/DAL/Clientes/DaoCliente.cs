...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            incluiAlteraBeneficiario(ret, cliente.ListaBenef);
          

            return ret;
        }

        private void incluiAlteraBeneficiario(long ret, List<Benef> listaBenef)
        {
            List<System.Data.SqlClient.SqlParameter> parametrosdel = new List<System.Data.SqlClient.SqlParameter>();
            parametrosdel.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", ret));
            base.Executar("FI_SP_ExcluiBeneficiario", parametrosdel);
            ...
            foreach (var item in listaBenef)
            {
                ...
                parametros.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", ret));

                base.Executar("FI_SP_InsereBeneficiario", parametros);
            }
        ...
        internal void Alterar(DML.Cliente cliente)
        {
            ...
            incluiAlteraBeneficiario(cliente.Id, cliente.ListaBenef);
        ...
        internal void Excluir(long Id)
        {
            ...
            List<System.Data.SqlClient.SqlParameter> parametrosdel = new List<System.Data.SqlClient.SqlParameter>();
            parametrosdel.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", Id));
            base.Executar("FI_SP_ExcluiBeneficiario", parametrosdel);
